...
import { FaPaperPlane, FaGithub, FaLinkedinIn, FaTwitter } from "react-icons/fa";
const Footer = () => {
  return (
    <footer className='bg-[#1f2937] pt-12 '>
      ...
      <div className="container">
        <div className="sm:flex items-center justify-between md:gap-8 ">
          <div className="w-full sm:w-1/2">
            ...
            <a href="#contact">
              <button className=" flex  items-center gap-2  text-white bg-violet-500 border font-600  border-solid border-violet-500  px-4 rounded-[9px]  hover:opacity-75  hover:text-opacity-100 hover:font-[500]  p-2 " >Hire Me<FaPaperPlane /></button>
            </a>
          </div>
          <div className=" w-full sm:w-1/2">
      ...
      {/* footer top  end */}
      {/* footer bottom  */}
      <div className=' bg-[#1b1e29] mt-5 text-center flex justify-center align-center align-middle'>
        <p className='text-gray-400 leading-7 text-[13px] '>
