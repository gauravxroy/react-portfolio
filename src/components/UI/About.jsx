  ...
  return (
    <section id="about" className=" bg-[#1f2937] ">
      ...
      >
        ...
        ></div> */}
        <div className="border-solid border-2  lg:border-gray-400 bg-white rounded-xl p-4 flex flex-col justify-between leading-normal">
          <div className="mb-8">
          ...
          <div className="flex items-center">
            ...
            <div className="text-sm">
              <p className="text-gray-900 leading-none">Gaurav Roy</p>
