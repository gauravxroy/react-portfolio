...
const Projects = () => {
  return (
    <section id="projects" className="bg-[#1f2937]">
      <div className="container ">
        ...
        <div className=" flex items-center justify-center  gap-5 flex-wrap cursor-pointer">
          {/* 1st card start */}
          <div
            className="cardshadow w-full bg-white p-4  border-solid border-2  lg:w-1/4 rounded-xl hover:opacity-90 hover:scale-105 transform transition duration-500 hover:shadow-md "
            data-aos="zoom-in-up"
          ...
          >
            ...
            <div>
              ...
              <p className="text-gray-700">
                Web Application For Watching movies Developed using MERN Stack{" "}
              </p>
          ...
          >
            ...
            <div>
              <h2 className="pt-4  text-violet-500">
                {" "}
                E-Commerce Landing Page{" "}
              </h2>
              <p className="text-gray-700">
                E-Commerce Landing Page Developed Using React.js, Tailwind Css{" "}
              </p>
              <button className="border-[1.5px] rounded-xl max-h-10 px-4 p-2 mt-4  text-white  font-600 bg-violet-500 border-solid border-violet-500  hover:bg-white hover:text-violet-500 hover:font-[500] ease-in duration-300">
                View{" "}
              </button>
